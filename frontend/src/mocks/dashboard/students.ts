...
export const students: Student[] = [
  ...
  },
  {
    ...
    avatarColor: 'bg-[#bd6247]',
    average: 9.2,
    lastCorrection: 'Il y a 2 semaines',
    status: 'Copie à corriger',
    grades: [
      { subject: 'Français', score: 9, maxScore: 20, date: '09/07/2026', comment: 'Les réponses doivent être plus structurées.' },
      { subject: 'Grammaire', score: 11, maxScore: 20, date: '03/07/2026', comment: "Quelques erreurs d'accord." },
      { subject: 'Expression', score: 9, maxScore: 20, date: '27/06/2026', comment: 'Manque de précision dans les formulations.' },
    ],
  },
  {
    id: 'sofia-blanc',
    ...
    avatarColor: 'bg-[#5f9674]',
    average: 14.7,
    lastCorrection: 'Il y a 3 jours',
    status: 'Copie corrigée',
    grades: [
      { subject: 'Sciences', score: 15, maxScore: 20, date: '17/07/2026', comment: 'Raisonnement clair et bien présenté.' },
      { subject: 'Histoire', score: 14, maxScore: 20, date: '10/07/2026', comment: 'Bonnes connaissances générales.' },
      { subject: 'Français', score: 15, maxScore: 20, date: '04/07/2026', comment: 'Expression fluide.' },
    ],
  },
]
